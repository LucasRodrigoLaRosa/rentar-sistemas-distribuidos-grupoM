...
public class VehiculoModificacionDTO {
    ...
    public VehiculoModificacionDTO() {}
    

    public VehiculoModificacionDTO(String marca, String modelo, Integer anio, String color, tipoVehiculo tipo,
